...
"""autogenerated by genpy from interbotix_turret_control/TurretJoyControl.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  __slots__ = ['pan_cmd','tilt_cmd','speed_cmd','toggle_speed_cmd']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       pan_cmd,tilt_cmd,speed_cmd,toggle_speed_cmd
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4b().pack(_x.pan_cmd, _x.tilt_cmd, _x.speed_cmd, _x.toggle_speed_cmd))
